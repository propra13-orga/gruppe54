...
public class Waffe extends Rectangle {
	...
	public static void Kollision(){
		if((((x+28 >= GegnerRL.StartX)&&(x+28 <= GegnerRL.StartX+32))
				&&((y+30 >= GegnerRL.StartY)&&(y+30 <= GegnerRL.StartY+32)))||
		   (((x-4 >= GegnerRL.StartX)&&(x-4 <= GegnerRL.StartX+32))
				&&((y+30 >= GegnerRL.StartY)&&(y+30 <= GegnerRL.StartY+32)))||
		   (((x-4 >= GegnerRL.StartX)&&(x-4 <= GegnerRL.StartX+32))
				&&((y+4 >= GegnerRL.StartY)&&(y+4 <= GegnerRL.StartY+32)))||
		   (((x+28 >= GegnerRL.StartX)&&(x+28 <= GegnerRL.StartX+32))
				&&((y+4 >= GegnerRL.StartY)&&(y+4 <= GegnerRL.StartY+32)))){
			switch(ID){
		...
		if((((x+28 >= GegnerOU.StartX)&&(x+28 <= GegnerOU.StartX+32))
				&&((y+30 >= GegnerOU.StartY)&&(y+30 <= GegnerOU.StartY+32)))||
		   (((x-4 >= GegnerOU.StartX)&&(x-4 <= GegnerOU.StartX+32))
				&&((y+30 >= GegnerRL.StartY)&&(y+30 <= GegnerOU.StartY+32)))||
		   (((x-4 >= GegnerOU.StartX)&&(x-4 <= GegnerOU.StartX+32))
				&&((y+4 >= GegnerOU.StartY)&&(y+4 <= GegnerOU.StartY+32)))||
		   (((x+28 >= GegnerOU.StartX)&&(x+28 <= GegnerOU.StartX+32))
				&&((y+4 >= GegnerOU.StartY)&&(y+4 <= GegnerOU.StartY+32)))){
			switch(ID){
		...
		if((((x+28 >= Endgegner.StartX)&&(x+28 <= Endgegner.StartX+32))
				&&((y+30 >= Endgegner.StartY)&&(y+30 <= Endgegner.StartY+32)))||
		   (((x-4 >= Endgegner.StartX)&&(x-4 <= Endgegner.StartX+32))
				&&((y+30 >= Endgegner.StartY)&&(y+30 <= Endgegner.StartY+32)))||
		   (((x-4 >= Endgegner.StartX)&&(x-4 <= Endgegner.StartX+32))
				&&((y+4 >= Endgegner.StartY)&&(y+4 <= Endgegner.StartY+32)))||
		   (((x+28 >= Endgegner.StartX)&&(x+28 <= Endgegner.StartX+32))
				&&((y+4 >= Endgegner.StartY)&&(y+4 <= Endgegner.StartY+32)))){
			switch(ID){
